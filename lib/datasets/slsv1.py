...
import os
import sys
# sys.path.append('/home/yochin/py-faster-rcnn/lib')
import codecs
...
class slsv1(imdb):
    def __init__(self, image_set, devkit_path='/home/yochin/Desktop/ModMan_ETRI'):       # '/media/yochin/DataStorage/Desktop/ModMan_DB/ETRI_HMI/ModMan_SLSv1'
        ...
        # ModMan classes - DB for synthetic data
        self._classes = DB_LIST
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_slsv1_annotation(index)
    ...
    def _load_slsv1_annotation_xml(self, index):
        """
        Load image and bounding boxes info from xml files of Database.
        """
        ...
        for ix, obj in enumerate(objs):
            ...
            cls = self._class_to_ind[obj.find('name').text.lower()]
    ...
    def _load_slsv1_annotation_txt(self, index):
        """
        Load image and bounding boxes info from txt files of Database.
        """
        ...
        for ix, obj in enumerate(objs):
            ...
            x2 = float(objinfo[4])
            y2 = float(objinfo[3])
            cls = self._class_to_ind[objinfo[0]]
            boxes[ix, :] = [x1, y1, x2, y2]
            gt_classes[ix] = cls
            overlaps[ix, cls] = 1.0
    ...
    def _load_slsv1_annotation(self, index):
        # return self._load_slsv1_annotation_txt(index)
        return self._load_slsv1_annotation_xml(index)

    def _write_slsv1_results_file(self, all_boxes):
