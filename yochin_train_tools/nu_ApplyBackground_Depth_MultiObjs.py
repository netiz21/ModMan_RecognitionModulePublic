...
if __name__ == '__main__':
    ...
    nNumMultiple = 4
    pathImageFolders = '/media/jang/ModMan DB/ModMan DB/ETRI_HMI/SLS.3DPose/SLSv1.MultiObjectsSet_%d'%nNumMultiple
    backgFolder = '/media/jang/ModMan DB/otherDBs/NewNegative'  # 배경: 약 8000장
