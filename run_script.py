...
'''
# fid = open('/home/yochin/Desktop/ModMan_ETRI/log2_DataSet.txt', 'w')
# print >> fid, 'start time : ', datetime.datetime.now()
# # os.system('python ./yochin_tools/nu_ApplyBackground_Depth_KIRIA.py')
# os.system('python ./yochin_tools/nu_GetBBInfofromMask.py')
# print >> fid, 'stop time : ', datetime.datetime.now()
# fid.close()

fid = open('/home/yochin/Desktop/ModMan_ETRI/log2_Training.txt', 'w')
print >> fid, 'start time : ', datetime.datetime.now()
